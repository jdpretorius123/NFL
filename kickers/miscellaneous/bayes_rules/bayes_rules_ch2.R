...
#'  
#' The Likelihood allows us to compare the relative likelihood of observing data
#' y under different values of the parameter
#' 
#' The conditional pmf/pdf allows us to compare the probabilities of different
#' possible values of data Y occurring with a given value of the parameter
#' 
#' The likelihood function allows us to evaluate the relative compatibility of 
#' the observed data with various values of the parameter of interest
